...
def Hel(x):
    ...
    D =  np.array([0.020,  0.020,  0.003])
    b =  np.array([0.400,  0.650,  0.650])
    Re = np.array([4.000,  4.500,  6.000])
    c =  np.array([0.020,  0.000,  0.020])
    
    A =  np.array([0.005,  0.005])
    Rcross =  np.array([3.400,  4.970])
